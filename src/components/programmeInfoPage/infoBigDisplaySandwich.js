...
function InfoBigDisplaySandwichPhd(props){
          ...
          >
           ...
           <Accordion>
            ...
            <Box pad="medium" margin={{top:'medium',bottom:'medium'}} background="light-2">
                ...
                <Text >&emsp;• Students in their Doctoral Programme.</Text>
                <Text >&emsp;• Third cycle (Doctoral or equivalent) EQF 8</Text>
                </Box>
            </AccordionPanel>
            <AccordionPanel label="Is there any funding and support?" style={{ fontWeight: "bold" }}>
            <Box pad="medium" margin={{top:'medium',bottom:'medium'}} background="light-2">
                 <Text> Since the Programme supported here are mandatory for your Educational Programme which means the project work at GSI./FAIR is integral part of your research work to recieve your Doctoral degree.
There is a possibility of financial support to doctoral researchers.</Text>
                <br/>
                ...
                <Text >&emsp;• Not every doctoral researcher qualifies for this support. The decision will be based on several factors such as Project description, viability of the project at FAIR/GSI, merit of the candidate.</Text>
                <Text >&emsp;• Support towards accomodation is always subject to the availability of the accommodation at our Guesthouses.</Text>
            ...
            <AccordionPanel label="Projects are available" style={{ fontWeight: "bold" }}>
                <Box pad="medium" background="light-2">
                <Text>In year 2022, the Programme plans to accept up to 10 doctoral reseacher in this Programme.
An application through the Programme does not guarantee a Sandwich PhD position.</Text>
                </Box>
            </AccordionPanel>
            <AccordionPanel label="Duration" style={{ fontWeight: "bold" }}>
                <Box pad="medium" background="light-2">
                <Text>You can benefit from the GI: SIP as a student affiliated to a recognized University or education institution outside of Germany. A typical PhD spends a minimum of 3 months and a maximum of 2 years. This duration has to be agreed prior to the start of the stay. The duration can be extended with respect to your project requirement.</Text>
                </Box>
            </AccordionPanel>
            <AccordionPanel label="Selection procedure" style={{ fontWeight: "bold" }}>
                <Box pad="medium" background="light-2">
                <Text>There are <b>four</b> phases of selection. The process can take 4-6 weeks to provide a confirmation on a Sandwich PhD project.</Text><br/>
            ...
            <AccordionPanel label="Process steps" style={{ fontWeight: "bold" }}>
                ...
                <Text >&emsp;• Master degree ertificate (transcripts in English language)</Text>
                ...
                <Text >&emsp;• or you have been informed about your tentative Sandwish PhD project [they must enter the hosting department or contact person’s name in the comment section]</Text>
                ...
                <Text >&emsp;• when an appropriate Sandwish PhD project is found, you are notified for next steps and a confirmation letter is sent [the candidate may have telephonic/video interview with one or more potential project mentors]</Text>
                ...
                <Text >&emsp;• Confirmation of funding from your higher education institution or your funding organization will be clarified. This step is mandatory to prepare the Sandwich PhD agreement and clarify the project goals, duration and confirmation from the sending institution.</Text>
                ...
                <Text >&emsp;• Confirmation letter with an Invitation and Programme agreement will be sent to those successful students.</Text>
            ...
            <AccordionPanel label="Useful links and downloads" style={{ fontWeight: "bold" }}>
                ...
                <Text >&emsp;• <Anchor onClick={function(){window.open('https://europa.eu/europass/en/description-eight-eqf-levels')}}>EQF: European Qualifications Framework</Anchor></Text>
                </Box>
            </AccordionPanel>
...
export {InfoBigDisplaySandwichPhd}