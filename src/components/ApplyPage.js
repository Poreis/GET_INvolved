...
function changeToApply() {
  window.open(
    "https://www.gsi.de/jobskarriere/angebote_fuer_studierende/get_involved_programme/get_involved_online_application",
    ...
    return (
      ...
      >
        ...
        >
          ...
          ></SquareCard>
          <SquareCard imgSrc="partner.jpg" href='/applyAsPartner' label="Partner"></SquareCard>
        </Box>
        <br />
        <Box
          direction="row"
          ...
          pad={{ left: "none", right: "none", vertical: "xlarge" }}
        >
          <Button
